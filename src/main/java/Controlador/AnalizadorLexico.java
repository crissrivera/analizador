...
public class AnalizadorLexico {
  ...
  Lexema lexe;
  public static FlujoCaracteres flujo = new FlujoCaracteres(0, null);
  ...
  public void analizar(FlujoCaracteres flu) {
    ...
    do {
      posicionInicial = flujo.getPosActual();
      Analizador_bit();
      Analizador_archivo();
      Analizador_neg();
      Analizador_suma();
  ...
  /**
   * Metodo que valida los espacios.
   * @param pos posicion.
   * @return posicion.
   */
  ...
  /**
   * Meotod que identifica que se analiza.
   */
  public void identificadores() {
    String identificador = "";
    if (flujo.getPosActual() == posicionInicial) {
  ...
  public void Analizador_entonces() {
    Analizador_entonces s = new Analizador_entonces();
    lexe = s.inicio(flujo);
    if (lexe != null) {
      listLexema.add(lexe);
    }
